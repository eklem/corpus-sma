...
<xsl:variable name="para_eng" select="'the-future-of-the-norwegian-government-q.html_id=670543'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'regjeringskvartalets-framtid-2.html_id=670543'"/>
...
<xsl:variable name="para_smj" select="'raehuskvartala-boahtteaigi.html_id=670543'"/>
