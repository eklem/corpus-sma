...
<xsl:variable name="para_eng" select="'bjorn-olav-megard-to-lead-the-department.html_id=681004'"/>
...
<xsl:variable name="para_smj" select="'bjorn-olav-megard-nammaduvvon-joihit-sam.html_id=681004'"/>
