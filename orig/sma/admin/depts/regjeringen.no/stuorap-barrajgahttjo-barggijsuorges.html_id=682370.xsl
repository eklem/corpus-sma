...
<xsl:variable name="para_nno" select="'okt-tilsyn-med-bemanningsbransjen.html_id=682370'"/>
...
<xsl:variable name="para_smj" select="'stuorap-barrajgahttjo-barggijsuorges.html_id=682370'"/>
