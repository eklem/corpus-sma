...
<xsl:variable name="para_nob" select="'norge-lager-oversikt-om-oppfolgingen-av-.html_id=682549'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'raehus-rahkada-ollislavuoa-vardosa-dan-h.html_id=682549'"/>
<xsl:variable name="para_smj" select="'raehus-rahkada-ollislavuoa-vardosa-dan-h.html_id=682549'"/>
