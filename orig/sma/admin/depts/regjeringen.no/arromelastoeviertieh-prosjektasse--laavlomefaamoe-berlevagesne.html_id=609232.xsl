...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/Preassaguovdda/Preassadieahusat/2010/Arromelastoeviertieh-prosjektasse--Laavlomefaamoe-Berlevagesne.html_id=609232'"/>
...
<xsl:variable name="para_nno" select="'bulystmidlar-til-prosjektet-sangkraft-i-berlevag.html_id=609232'"/>
