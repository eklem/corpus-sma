...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/Preassaguovdda/Preassadieahusat/2010/Arromelastoeviertieh-prosjektasse-Iedtjeles-noereraerieh-Finnmarkesne.html_id=610385'"/>
...
<xsl:variable name="para_nno" select="'bulystmidlar-til-prosjektet-aktive-ungdomsrad-i-finnmark.html_id=610385'"/>
