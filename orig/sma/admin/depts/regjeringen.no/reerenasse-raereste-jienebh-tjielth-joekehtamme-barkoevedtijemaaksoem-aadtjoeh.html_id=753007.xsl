...
<xsl:variable name="para_nno" select="'til-Kautokeino.html_id=753403'"/>
<xsl:variable name="para_nob" select="'Regjeringen-foreslar-at-flere-kommuner-far-differensiert-arbeidsgiveravgift-.html_id=753007'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Nussir-ja-Gumpenjuni-regulerenplana.html_id=753353'"/>
