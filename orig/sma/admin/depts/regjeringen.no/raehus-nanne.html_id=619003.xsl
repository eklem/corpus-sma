...
<xsl:variable name="para_nob" select="'regjeringen-styrker-satsingen-pa-samiske.html_id=619003'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'raehus-nanne.html_id=619003'"/>
<xsl:variable name="para_smj" select="'raehus-nanne.html_id=619003'"/>
