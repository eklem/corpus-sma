...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fd/Aigeguovdil/Oasat/2010/Lahkoebieljelimmiem-sjeakodh.html_id=605748'"/>
...
<xsl:variable name="para_nob" select="'rydder-opp-i-registerrapportering.html_id=605748'"/>
