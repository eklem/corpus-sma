...
<xsl:variable name="para_nob" select="'spraktiltak.html_id=603613'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'185-miljovdna-doarjjan-aarjel--ja-julevsami-gielladoaimmaide.html_id=603613'"/>
<xsl:variable name="para_smj" select="'185-miljovdna-doarjjan-aarjel--ja-julevsami-gielladoaimmaide.html_id=603613'"/>
