...
<xsl:variable name="para_nob" select="'ny-valgordning-til-sametingsvalget-2009.html_id=566781'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'oa-valgaortnet-samediggevalgii-2009.html_id=566781'"/>
<xsl:variable name="para_smj" select="'oa-valgaortnet-samediggevalgii-2009.html_id=566781'"/>
