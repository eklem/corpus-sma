...
<xsl:variable name="para_nob" select="'foreslar-ny-pensjonsordning-for-sameting.html_id=684536'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'orre-pensjovneoornegem-raereste-saemiedi.html_id=684536'"/>
<xsl:variable name="para_smj" select="'orre-pensjovneoornegem-raereste-saemiedi.html_id=684536'"/>
