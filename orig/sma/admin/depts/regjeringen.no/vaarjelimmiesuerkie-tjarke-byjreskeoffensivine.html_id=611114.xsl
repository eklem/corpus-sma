...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fd/Aigeguovdil/Oasat/2010/Vaarjelimmiesuerkie-tjarke-byjreskeoffensivine.html_id=611114'"/>
...
<xsl:variable name="para_nno" select="'forsvarssektoren-med-malretta-miljooffen.html_id=611114'"/>
