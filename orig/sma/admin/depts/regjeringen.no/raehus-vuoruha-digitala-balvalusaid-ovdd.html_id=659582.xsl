...
<xsl:variable name="para_sme" select="'raehus-vuoruha-digitala-balvalusaid-ovdd.html_id=659582'"/>
<xsl:variable name="para_smj" select="'raehus-vuoruha-digitala-balvalusaid-ovdd.html_id=659582'"/>
