...
<xsl:variable name="para_nob" select="'politianalysen-overlevert-til-faremo.html_id=730801'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'raehus-aigu-alkidahttit-du-ja-mu-argabea.html_id=731194'"/>
