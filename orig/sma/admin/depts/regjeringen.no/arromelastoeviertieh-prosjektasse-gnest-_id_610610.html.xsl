...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/Preassaguovdda/Preassadieahusat/2010/arromelastoeviertieh-prosjektasse-gnest-.html?id=610610'"/>
<xsl:variable name="title" select="'Årromelastoeviertieh prosjektasse ”Gnest” Snåasesne - regjeringen.no'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="bulystmidlar-til-prosjektet-gnest-i-snasa.html_id=610610" xml:lang="nno"/>
</xsl:variable>
