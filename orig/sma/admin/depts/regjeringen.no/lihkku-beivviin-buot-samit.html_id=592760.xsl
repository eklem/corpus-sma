...
<xsl:variable name="para_nob" select="'gratulerer-med-dagen-alle-samer.html_id=592760'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'lihkku-beivviin-buot-samit.html_id=592760'"/>
<xsl:variable name="para_smj" select="'lihkku-beivviin-buot-samit.html_id=592760'"/>
